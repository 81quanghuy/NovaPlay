 ...
 * <p>
 * Không có lớp này, Spring Security dùng {@code Http403ForbiddenEntryPoint} mặc định, nên request
 * KHÔNG có danh tính cũng nhận 403 thay vì 401 — và frontend chỉ kích hoạt luồng refresh token khi
 * thấy 401.
 */
@Component
