...
/**
 * Danh tính người dùng đến từ header do gateway inject, không phải JWT tự xác thực ở đây.
 * Principal sau filter này là chuỗi email — {@code NotificationController} dùng nó làm khoá
 * duy nhất để lọc dữ liệu của đúng người gọi.
 */
@Component
