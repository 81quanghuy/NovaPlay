...
public class GatewayAuthFilter extends OncePerRequestFilter {
     ...
     * chạy trước chuỗi MVC nên không được phép phụ thuộc vào việc ObjectMapper được inject có đăng
     * ký JavaTimeModule hay chưa. Đây là đường trả lỗi bảo mật — nó phải luôn ghi ra được phản hồi.
     */
